	...
	<c:forEach items="${inventory.getItems()}" var="entry">
		<c:if test="${entry.value > 0}">
			...
			<c:if test="${entry.key == 'item1'}">
				<div class="container">
					<img src="<c:url value='/resources/images/1.png'/>" alt="Sneakers">
			...
			<c:if test="${entry.key == 'item2'}">
				<div class="container">
					<img src="<c:url value='/resources/images/2.png'/>" alt="Laptop">
			...
			<c:if test="${entry.key == 'item3'}">
				<div class="container">
					<img src="<c:url value='/resources/images/6.png'/>" alt="Keyboard">
			...
			<c:if test="${entry.key == 'item4'}">
				<div class="container">
					<img src="<c:url value='/resources/images/3.png'/>" alt="Book">
			...
			<c:if test="${entry.key == 'item5'}">
				<div class="container">
					<img src="<c:url value='/resources/images/4.png'/>" alt="Ring">
			...
			<c:if test="${entry.key == 'item6'}">
				<div class="container">
					<img src="<c:url value='/resources/images/5.png'/>" alt="Banana">
